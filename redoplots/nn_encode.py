...
class Encoder(object):
    ...
    def __init__(self, x, y, adjust_scale=0, reg_pt_scale=1.0, drop_ge11=False, 
                 drop_ge21=False, drop_me0=False, drop_irpc=False,robust=False):
        if robust==True:
            drop_ge11=True
            drop_ge21=True
            drop_irpc=True
            print('robut=True. droping GEM and iRPC')
