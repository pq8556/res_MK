...
def muon_data(filename, adjust_scale=0, reg_pt_scale=1.0, correct_for_eta=False,robust=False):
  try:
  ...
  encoder = Encoder(the_variables, the_parameters, adjust_scale=adjust_scale, reg_pt_scale=reg_pt_scale,robust=robust)
  if correct_for_eta:
...
def muon_data_split(filename, adjust_scale=0, reg_pt_scale=1.0, test_size=0.5, correct_for_eta=False,robust=False):
  x, y, w, x_mask = muon_data(filename, adjust_scale=adjust_scale, reg_pt_scale=reg_pt_scale, correct_for_eta=correct_for_eta,robust=robust)
...
# ______________________________________________________________________________
def pileup_data(filename, adjust_scale=0, reg_pt_scale=1.0,robust=False):
  try:
...
def pileup_data_split(filename, adjust_scale=0, reg_pt_scale=1.0, test_job=50,robust=False):
  x, aux, w, x_mask = pileup_data(filename, adjust_scale=adjust_scale, reg_pt_scale=reg_pt_scale,robust=robust)
